...
export default async function CountryDataPage({
  ...
  return (
    <div>
      <h2 className="text-2xl font-bold text-slate-900 mb-6">Data & Statistics</h2>
      <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-8 text-center">
        <p className="text-slate-500 mb-4">Interactive charts and trade data for {country.name}</p>
